; ModuleID = 'i16_window_split_256_to_128x2.ll'
source_filename = "/home/synthara/VersalPrjs/LDRD/rtda_demo/aieml7/window_split_256_to_128x2.cpp"
...
define dso_local void @_Z25window_split_256_to_128x2P12input_windowIfEP13output_windowIfES4_(ptr chesscopy noalias %in, ptr chesscopy noalias %out0, ptr chesscopy noalias %out1) addrspace(1) #0 !dbg !275 {
entry:
  ...
  %0 = call addrspace(1) ptr @llvm.noalias.decl.p0.p0.i32(ptr %in.addr, i32 0, metadata !293), !noalias !296
  store ptr %in, ptr %in.addr, align 4, !tbaa !299, !noalias !296
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %in.addr, metadata !284, metadata !DIExpression()), !dbg !303
  %1 = call addrspace(1) ptr @llvm.noalias.decl.p0.p0.i32(ptr %out0.addr, i32 0, metadata !304), !noalias !296
  store ptr %out0, ptr %out0.addr, align 4, !tbaa !299, !noalias !296
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %out0.addr, metadata !285, metadata !DIExpression()), !dbg !305
  %2 = call addrspace(1) ptr @llvm.noalias.decl.p0.p0.i32(ptr %out1.addr, i32 0, metadata !306), !noalias !296
  store ptr %out1, ptr %out1.addr, align 4, !tbaa !299, !noalias !296
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %out1.addr, metadata !286, metadata !DIExpression()), !dbg !307
  store i32 undef, ptr %HALF, align 4, !dbg !308, !noalias !296
  call addrspace(1) void @llvm.lifetime.start.p0(i64 4, ptr %HALF) #11, !dbg !308, !noalias !296
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %HALF, metadata !287, metadata !DIExpression()), !dbg !309
  store i32 128, ptr %HALF, align 4, !dbg !309, !tbaa !310, !noalias !296
  store i32 undef, ptr %i, align 4, !dbg !312, !noalias !296
  call addrspace(1) void @llvm.lifetime.start.p0(i64 4, ptr %i) #11, !dbg !312, !noalias !296
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %i, metadata !289, metadata !DIExpression()), !dbg !313
  store i32 0, ptr %i, align 4, !dbg !313, !tbaa !310, !noalias !296
  br label %for.cond, !dbg !312

for.cond:                                         ; preds = %for.inc, %entry
  %3 = load i32, ptr %i, align 4, !dbg !314, !tbaa !310, !noalias !296
  %cmp = icmp slt i32 %3, 128, !dbg !316
  br i1 %cmp, label %for.body, label %for.cond.cleanup, !dbg !317

for.cond.cleanup:                                 ; preds = %for.cond
  call addrspace(1) void @llvm.lifetime.end.p0(i64 4, ptr %i) #11, !dbg !318, !noalias !296
  br label %for.end

for.body:                                         ; preds = %for.cond
  %4 = load ptr, ptr %out0.addr, align 4, !dbg !319, !tbaa !299, !noalias !296
  %5 = call addrspace(1) ptr @llvm.noalias.p0.p0.p0.i32(ptr %4, ptr %1, ptr %out0.addr, i32 0, metadata !304), !dbg !319, !tbaa !299, !noalias !296
  %6 = load ptr, ptr %in.addr, align 4, !dbg !321, !tbaa !299, !noalias !296
  %7 = call addrspace(1) ptr @llvm.noalias.p0.p0.p0.i32(ptr %6, ptr %0, ptr %in.addr, i32 0, metadata !293), !dbg !321, !tbaa !299, !noalias !296
  %call = call noundef addrspace(1) float @_ZL15window_readincrIL15aie_dm_resource0EEfP12input_windowIfE(ptr %7) #12, !dbg !322, !noalias !296
  call addrspace(1) void @_ZL16window_writeincrIL15aie_dm_resource0EEvP13output_windowIfEf(ptr %5, float noundef %call) #12, !dbg !323, !noalias !296
  br label %for.inc, !dbg !324

for.inc:                                          ; preds = %for.body
  %8 = load i32, ptr %i, align 4, !dbg !325, !tbaa !310, !noalias !296
  %inc = add nsw i32 %8, 1, !dbg !325
  store i32 %inc, ptr %i, align 4, !dbg !325, !tbaa !310, !noalias !296
  br label %for.cond, !dbg !318, !llvm.loop !326

for.end:                                          ; preds = %for.cond.cleanup
  store i32 undef, ptr %i1, align 4, !dbg !329, !noalias !296
  call addrspace(1) void @llvm.lifetime.start.p0(i64 4, ptr %i1) #11, !dbg !329, !noalias !296
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %i1, metadata !291, metadata !DIExpression()), !dbg !330
  store i32 0, ptr %i1, align 4, !dbg !330, !tbaa !310, !noalias !296
  br label %for.cond2, !dbg !329

for.cond2:                                        ; preds = %for.inc7, %for.end
  %9 = load i32, ptr %i1, align 4, !dbg !331, !tbaa !310, !noalias !296
  %cmp3 = icmp slt i32 %9, 128, !dbg !333
  br i1 %cmp3, label %for.body5, label %for.cond.cleanup4, !dbg !334

for.cond.cleanup4:                                ; preds = %for.cond2
  call addrspace(1) void @llvm.lifetime.end.p0(i64 4, ptr %i1) #11, !dbg !335, !noalias !296
  br label %for.end9

for.body5:                                        ; preds = %for.cond2
  %10 = load ptr, ptr %out1.addr, align 4, !dbg !336, !tbaa !299, !noalias !296
  %11 = call addrspace(1) ptr @llvm.noalias.p0.p0.p0.i32(ptr %10, ptr %2, ptr %out1.addr, i32 0, metadata !306), !dbg !336, !tbaa !299, !noalias !296
  %12 = load ptr, ptr %in.addr, align 4, !dbg !338, !tbaa !299, !noalias !296
  %13 = call addrspace(1) ptr @llvm.noalias.p0.p0.p0.i32(ptr %12, ptr %0, ptr %in.addr, i32 0, metadata !293), !dbg !338, !tbaa !299, !noalias !296
  %call6 = call noundef addrspace(1) float @_ZL15window_readincrIL15aie_dm_resource0EEfP12input_windowIfE(ptr %13) #12, !dbg !339, !noalias !296
  call addrspace(1) void @_ZL16window_writeincrIL15aie_dm_resource0EEvP13output_windowIfEf(ptr %11, float noundef %call6) #12, !dbg !340, !noalias !296
  br label %for.inc7, !dbg !341

for.inc7:                                         ; preds = %for.body5
  %14 = load i32, ptr %i1, align 4, !dbg !342, !tbaa !310, !noalias !296
  %inc8 = add nsw i32 %14, 1, !dbg !342
  store i32 %inc8, ptr %i1, align 4, !dbg !342, !tbaa !310, !noalias !296
  br label %for.cond2, !dbg !335, !llvm.loop !343

for.end9:                                         ; preds = %for.cond.cleanup4
  call addrspace(1) void @llvm.lifetime.end.p0(i64 4, ptr %HALF) #11, !dbg !345
  ret void, !dbg !345
}
...
define internal void @_ZL16window_writeincrIL15aie_dm_resource0EEvP13output_windowIfEf(ptr %w, float noundef %value) addrspace(1) #4 !dbg !76 !noalias !346 {
entry:
  %w.addr = alloca ptr, align 4
  %value.addr = alloca float, align 4
  store ptr %w, ptr %w.addr, align 4, !tbaa !299, !noalias !346
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %w.addr, metadata !94, metadata !DIExpression()), !dbg !349
  store float %value, ptr %value.addr, align 4, !tbaa !350, !noalias !346
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %value.addr, metadata !95, metadata !DIExpression()), !dbg !349
  %0 = load float, ptr %value.addr, align 4, !dbg !349, !tbaa !350, !noalias !346
  %1 = load ptr, ptr %w.addr, align 4, !dbg !349, !tbaa !299, !noalias !346
  %ptr = getelementptr inbounds %struct.output_window, ptr %1, i32 0, i32 2, !dbg !349
  %2 = load ptr, ptr %ptr, align 4, !dbg !349, !tbaa !352, !noalias !346
  %3 = call addrspace(1) ptr @llvm.noalias.p0.p0.p0.i32(ptr %2, ptr null, ptr %ptr, i32 0, metadata !346), !dbg !349, !tbaa !352, !noalias !346
  store float %0, ptr %3, align 4, !dbg !349, !tbaa !350, !noalias !346
  %4 = load ptr, ptr %w.addr, align 4, !dbg !349, !tbaa !299, !noalias !346
  call addrspace(1) void @_ZL11window_incrP13output_windowIfEi(ptr %4, i32 noundef 1) #12, !dbg !349, !noalias !346
  ret void, !dbg !349
}
...
; Function Attrs: inlinehint mustprogress nounwind
define internal noundef float @_ZL15window_readincrIL15aie_dm_resource0EEfP12input_windowIfE(ptr %w) addrspace(1) #4 !dbg !354 {
entry:
  %w.addr = alloca ptr, align 4
  %value = alloca float, align 4
  store ptr %w, ptr %w.addr, align 4, !tbaa !299
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %w.addr, metadata !358, metadata !DIExpression()), !dbg !360
  store float undef, ptr %value, align 4, !dbg !360
  call addrspace(1) void @llvm.lifetime.start.p0(i64 4, ptr %value) #11, !dbg !360
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %value, metadata !359, metadata !DIExpression()), !dbg !360
  %0 = load ptr, ptr %w.addr, align 4, !dbg !360, !tbaa !299
  call addrspace(1) void @_ZL15window_readincrIL15aie_dm_resource0EEvP12input_windowIfERf(ptr %0, ptr nonnull align 4 dereferenceable(4) %value) #12, !dbg !360
  %1 = load float, ptr %value, align 4, !dbg !360, !tbaa !350
  call addrspace(1) void @llvm.lifetime.end.p0(i64 4, ptr %value) #11, !dbg !360
  ret float %1, !dbg !360
}
...
; Function Attrs: inlinehint mustprogress nounwind
define internal void @_ZL15window_readincrIL15aie_dm_resource0EEvP12input_windowIfERf(ptr %w, ptr nonnull align 4 dereferenceable(4) %value) addrspace(1) #4 !dbg !28 !noalias !361 {
entry:
  %w.addr = alloca ptr, align 4
  %value.addr = alloca ptr, align 4
  store ptr %w, ptr %w.addr, align 4, !tbaa !299, !noalias !361
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %w.addr, metadata !61, metadata !DIExpression()), !dbg !364
  store ptr %value, ptr %value.addr, align 4, !tbaa !299, !noalias !361
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %value.addr, metadata !62, metadata !DIExpression()), !dbg !364
  %0 = load ptr, ptr %w.addr, align 4, !dbg !364, !tbaa !299, !noalias !361
  %ptr = getelementptr inbounds %struct.input_window, ptr %0, i32 0, i32 2, !dbg !364
  %1 = load ptr, ptr %ptr, align 4, !dbg !364, !tbaa !365, !noalias !361
  %2 = call addrspace(1) ptr @llvm.noalias.p0.p0.p0.i32(ptr %1, ptr null, ptr %ptr, i32 0, metadata !361), !dbg !364, !tbaa !365, !noalias !361
  %3 = load float, ptr %2, align 4, !dbg !364, !tbaa !350, !noalias !361
  %4 = load ptr, ptr %value.addr, align 4, !dbg !364, !tbaa !299, !noalias !361
  store float %3, ptr %4, align 4, !dbg !364, !tbaa !350, !noalias !361
  %5 = load ptr, ptr %w.addr, align 4, !dbg !364, !tbaa !299, !noalias !361
  call addrspace(1) void @_ZL11window_incrP12input_windowIfEi(ptr %5, i32 noundef 1) #12, !dbg !364, !noalias !361
  ret void, !dbg !364
}

; Function Attrs: inlinehint mustprogress nounwind
define internal void @_ZL11window_incrP12input_windowIfEi(ptr %w, i32 noundef %count) addrspace(1) #4 !dbg !367 !noalias !373 {
entry:
  %w.addr = alloca ptr, align 4
  %count.addr = alloca i32, align 4
  store ptr %w, ptr %w.addr, align 4, !tbaa !299, !noalias !373
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %w.addr, metadata !371, metadata !DIExpression()), !dbg !376
  store i32 %count, ptr %count.addr, align 4, !tbaa !310, !noalias !373
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %count.addr, metadata !372, metadata !DIExpression()), !dbg !376
  %0 = load i32, ptr %count.addr, align 4, !dbg !376, !tbaa !310, !noalias !373
  %mul = mul i32 %0, 4, !dbg !376
  store i32 %mul, ptr %count.addr, align 4, !dbg !376, !tbaa !310, !noalias !373
  %1 = load ptr, ptr %w.addr, align 4, !dbg !376, !tbaa !299, !noalias !373
  %ptr = getelementptr inbounds %struct.input_window, ptr %1, i32 0, i32 2, !dbg !376
  %2 = load ptr, ptr %ptr, align 4, !dbg !376, !tbaa !365, !noalias !373
  %3 = call addrspace(1) ptr @llvm.noalias.p0.p0.p0.i32(ptr %2, ptr null, ptr %ptr, i32 0, metadata !373), !dbg !376, !tbaa !365, !noalias !373
  %4 = load i32, ptr %count.addr, align 4, !dbg !376, !tbaa !310, !noalias !373
  %5 = load ptr, ptr %w.addr, align 4, !dbg !376, !tbaa !299, !noalias !373
  %buffer = getelementptr inbounds %struct.input_window, ptr %5, i32 0, i32 5, !dbg !376
  %6 = load ptr, ptr %buffer, align 4, !dbg !376, !tbaa !377, !noalias !373
  %7 = call addrspace(1) ptr @llvm.noalias.p0.p0.p0.i32(ptr %6, ptr null, ptr %buffer, i32 0, metadata !373), !dbg !376, !tbaa !377, !noalias !373
  %8 = load ptr, ptr %w.addr, align 4, !dbg !376, !tbaa !299, !noalias !373
  %size = getelementptr inbounds %struct.input_window, ptr %8, i32 0, i32 7, !dbg !376
  %9 = load i32, ptr %size, align 4, !dbg !376, !tbaa !378, !noalias !373
  %call = call addrspace(1) ptr @_Z10cyclic_addPaiS_j(ptr %3, i32 noundef %4, ptr %7, i32 noundef %9) #12, !dbg !376, !noalias !373
  %10 = load ptr, ptr %w.addr, align 4, !dbg !376, !tbaa !299, !noalias !373
  %ptr1 = getelementptr inbounds %struct.input_window, ptr %10, i32 0, i32 2, !dbg !376
  store ptr %call, ptr %ptr1, align 4, !dbg !376, !tbaa !365, !noalias !373
  ret void, !dbg !376
}

; Function Attrs: inlinehint mustprogress nounwind
define linkonce_odr dso_local ptr @_Z10cyclic_addPaiS_j(ptr %ptr, i32 noundef %count, ptr %base, i32 noundef %size) addrspace(1) #4 comdat !dbg !379 {
entry:
  ...
  store ptr %ptr, ptr %ptr.addr, align 4, !tbaa !299
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %ptr.addr, metadata !383, metadata !DIExpression()), !dbg !390
  store i32 %count, ptr %count.addr, align 4, !tbaa !310
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %count.addr, metadata !384, metadata !DIExpression()), !dbg !391
  store ptr %base, ptr %base.addr, align 4, !tbaa !299
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %base.addr, metadata !385, metadata !DIExpression()), !dbg !392
  store i32 %size, ptr %size.addr, align 4, !tbaa !310
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %size.addr, metadata !386, metadata !DIExpression()), !dbg !393
  store %struct.ipd.custom_type.addr_t.addr_t undef, ptr %c0, align 4, !dbg !394
  call addrspace(1) void @llvm.lifetime.start.p0(i64 4, ptr %c0) #11, !dbg !394
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %c0, metadata !387, metadata !DIExpression()), !dbg !395
  %0 = load ptr, ptr %ptr.addr, align 4, !dbg !396, !tbaa !299
  %1 = ptrtoint ptr %0 to i32, !dbg !397
  call addrspace(1) void @_ZN6addr_tC2Ei(ptr nonnull align 4 dereferenceable(3) %custom_type.tmp, i32 %1) #12, !dbg !397
  %2 = load %struct.ipd.custom_type.addr_t.addr_t, ptr %custom_type.tmp, align 4, !dbg !397, !tbaa !398
  store %struct.ipd.custom_type.addr_t.addr_t %2, ptr %c0, align 4, !dbg !397, !tbaa !398
  store %struct.ipd.custom_type.addr_t.addr_t undef, ptr %c1, align 4, !dbg !400
  call addrspace(1) void @llvm.lifetime.start.p0(i64 4, ptr %c1) #11, !dbg !400
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %c1, metadata !389, metadata !DIExpression()), !dbg !401
  %3 = load ptr, ptr %ptr.addr, align 4, !dbg !402, !tbaa !299
  %4 = ptrtoint ptr %3 to i32, !dbg !403
  call addrspace(1) void @_ZN6addr_tC2Ei(ptr nonnull align 4 dereferenceable(3) %custom_type.tmp1, i32 %4) #12, !dbg !403
  %5 = load %struct.ipd.custom_type.addr_t.addr_t, ptr %custom_type.tmp1, align 4, !dbg !403, !tbaa !398
  store %struct.ipd.custom_type.addr_t.addr_t %5, ptr %c1, align 4, !dbg !403, !tbaa !398
  %6 = load ptr, ptr %ptr.addr, align 4, !dbg !404, !tbaa !299
  %7 = load i32, ptr %count.addr, align 4, !dbg !405, !tbaa !310
  %8 = load i32, ptr %size.addr, align 4, !dbg !406, !tbaa !310
  %sub = sub i32 %7, %8, !dbg !407
  %9 = load ptr, ptr %base.addr, align 4, !dbg !408, !tbaa !299
  %10 = load i32, ptr %count.addr, align 4, !dbg !409, !tbaa !310
  %idx.neg = sub i32 0, %10, !dbg !410
  %add.ptr = getelementptr inbounds i8, ptr %9, i32 %idx.neg, !dbg !410
  %11 = ptrtoint ptr %add.ptr to i32, !dbg !411
  %12 = load i32, ptr %count.addr, align 4, !dbg !412, !tbaa !310
  %13 = load i32, ptr %size.addr, align 4, !dbg !413, !tbaa !310
  %add = add i32 %12, %13, !dbg !414
  %14 = load ptr, ptr %base.addr, align 4, !dbg !415, !tbaa !299
  %15 = load i32, ptr %count.addr, align 4, !dbg !416, !tbaa !310
  %idx.neg2 = sub i32 0, %15, !dbg !417
  %add.ptr3 = getelementptr inbounds i8, ptr %14, i32 %idx.neg2, !dbg !417
  %16 = load i32, ptr %size.addr, align 4, !dbg !418, !tbaa !310
  %add.ptr4 = getelementptr inbounds i8, ptr %add.ptr3, i32 %16, !dbg !419
  %17 = ptrtoint ptr %add.ptr4 to i32, !dbg !420
  %18 = load i32, ptr %count.addr, align 4, !dbg !421, !tbaa !310
  %call = call addrspace(1) ptr @_Z11add_3d_byteIaEPT_S1_iiR6addr_tiiS3_i(ptr %6, i32 noundef %sub, i32 noundef %11, ptr nonnull align 4 dereferenceable(3) %c0, i32 noundef %add, i32 noundef %17, ptr nonnull align 4 dereferenceable(3) %c1, i32 noundef %18) #12, !dbg !422
  call addrspace(1) void @llvm.lifetime.end.p0(i64 4, ptr %c1) #11, !dbg !423
  call addrspace(1) void @llvm.lifetime.end.p0(i64 4, ptr %c0) #11, !dbg !423
  ret ptr %call, !dbg !424
}
...
entry:
  ...
  store ptr %this, ptr %this.addr, align 4, !tbaa !299
  store i32 %a, ptr %a.addr, align 4, !tbaa !310
  %this1 = load ptr, ptr %this.addr, align 4
  store i20 0, ptr %this1, align 4
  %0 = load i32, ptr %a.addr, align 4, !tbaa !310
...
; Function Attrs: inlinehint mustprogress nounwind
define linkonce_odr dso_local ptr @_Z11add_3d_byteIaEPT_S1_iiR6addr_tiiS3_i(ptr %a, i32 noundef %off, i32 noundef %size1, ptr nonnull align 4 dereferenceable(3) %count1, i32 noundef %inc1, i32 noundef %size2, ptr nonnull align 4 dereferenceable(3) %count2, i32 noundef %inc2) addrspace(1) #4 comdat !dbg !425 {
entry:
  ...
  store ptr %a, ptr %a.addr, align 4, !tbaa !299
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %a.addr, metadata !430, metadata !DIExpression()), !dbg !443
  store i32 %off, ptr %off.addr, align 4, !tbaa !310
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %off.addr, metadata !431, metadata !DIExpression()), !dbg !444
  store i32 %size1, ptr %size1.addr, align 4, !tbaa !310
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %size1.addr, metadata !432, metadata !DIExpression()), !dbg !445
  store ptr %count1, ptr %count1.addr, align 4, !tbaa !299
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %count1.addr, metadata !433, metadata !DIExpression()), !dbg !446
  store i32 %inc1, ptr %inc1.addr, align 4, !tbaa !310
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %inc1.addr, metadata !434, metadata !DIExpression()), !dbg !447
  store i32 %size2, ptr %size2.addr, align 4, !tbaa !310
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %size2.addr, metadata !435, metadata !DIExpression()), !dbg !448
  store ptr %count2, ptr %count2.addr, align 4, !tbaa !299
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %count2.addr, metadata !436, metadata !DIExpression()), !dbg !449
  store i32 %inc2, ptr %inc2.addr, align 4, !tbaa !310
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %inc2.addr, metadata !437, metadata !DIExpression()), !dbg !450
  store %struct.ipd.custom_type.addr_t.addr_t undef, ptr %c, align 4, !dbg !451
  call addrspace(1) void @llvm.lifetime.start.p0(i64 4, ptr %c) #11, !dbg !451
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %c, metadata !438, metadata !DIExpression()), !dbg !452
  store %struct.ipd.custom_type.addr_t.addr_t undef, ptr %c2, align 4, !dbg !453
  call addrspace(1) void @llvm.lifetime.start.p0(i64 4, ptr %c2) #11, !dbg !453
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %c2, metadata !439, metadata !DIExpression()), !dbg !454
  store ptr undef, ptr %r, align 4, !dbg !455
  call addrspace(1) void @llvm.lifetime.start.p0(i64 4, ptr %r) #11, !dbg !455
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %r, metadata !440, metadata !DIExpression()), !dbg !456
  %0 = load ptr, ptr %a.addr, align 4, !dbg !457, !tbaa !299
  %1 = load i32, ptr %off.addr, align 4, !dbg !458, !tbaa !310
  %2 = load i32, ptr %inc1.addr, align 4, !dbg !459, !tbaa !310
  %3 = load i32, ptr %inc2.addr, align 4, !dbg !460, !tbaa !310
  %4 = load i32, ptr %size1.addr, align 4, !dbg !461, !tbaa !310
  call addrspace(1) void @_ZN6addr_tC2Ei(ptr nonnull align 4 dereferenceable(3) %custom_type.tmp, i32 %4) #12, !dbg !461
  %5 = load %struct.ipd.custom_type.addr_t.addr_t, ptr %custom_type.tmp, align 4, !dbg !461, !tbaa !398
  store %struct.ipd.custom_type.addr_t.addr_t %5, ptr %agg.tmp, align 4, !dbg !461, !tbaa !398
  %6 = load ptr, ptr %count1.addr, align 4, !dbg !462, !tbaa !299
  %7 = load i32, ptr %size2.addr, align 4, !dbg !463, !tbaa !310
  call addrspace(1) void @_ZN6addr_tC2Ei(ptr nonnull align 4 dereferenceable(3) %custom_type.tmp2, i32 %7) #12, !dbg !463
  %8 = load %struct.ipd.custom_type.addr_t.addr_t, ptr %custom_type.tmp2, align 4, !dbg !463, !tbaa !398
  store %struct.ipd.custom_type.addr_t.addr_t %8, ptr %agg.tmp1, align 4, !dbg !463, !tbaa !398
  %9 = load ptr, ptr %count2.addr, align 4, !dbg !464, !tbaa !299
  %10 = load %struct.ipd.custom_type.addr_t.addr_t, ptr %agg.tmp, align 4, !dbg !465, !tbaa !398
  %11 = load %struct.ipd.custom_type.addr_t.addr_t, ptr %6, align 4, !dbg !465, !tbaa !398
  %12 = load %struct.ipd.custom_type.addr_t.addr_t, ptr %agg.tmp1, align 4, !dbg !465, !tbaa !398
  %13 = load %struct.ipd.custom_type.addr_t.addr_t, ptr %9, align 4, !dbg !465, !tbaa !398
  ...
  store ptr %call, ptr %r, align 4, !dbg !456, !tbaa !299
  %14 = load ptr, ptr %count1.addr, align 4, !dbg !466, !tbaa !299
  %15 = load %struct.ipd.custom_type.addr_t.addr_t, ptr %c, align 4, !dbg !467, !tbaa !398
  store %struct.ipd.custom_type.addr_t.addr_t %15, ptr %14, align 4, !dbg !467, !tbaa !398
  %16 = load ptr, ptr %count2.addr, align 4, !dbg !468, !tbaa !299
  %17 = load %struct.ipd.custom_type.addr_t.addr_t, ptr %c2, align 4, !dbg !469, !tbaa !398
  store %struct.ipd.custom_type.addr_t.addr_t %17, ptr %16, align 4, !dbg !469, !tbaa !398
  %18 = load ptr, ptr %r, align 4, !dbg !470, !tbaa !299
  call addrspace(1) void @llvm.lifetime.end.p0(i64 4, ptr %r) #11, !dbg !471
  call addrspace(1) void @llvm.lifetime.end.p0(i64 4, ptr %c2) #11, !dbg !471
  call addrspace(1) void @llvm.lifetime.end.p0(i64 4, ptr %c) #11, !dbg !471
  ret ptr %18, !dbg !472
}
...
entry:
  ...
  store i32 %inc1, ptr %inc1.addr, align 4, !tbaa !310
  store i32 %inc2, ptr %inc2.addr, align 4, !tbaa !310
  store ptr %count1_out, ptr %count1_out.addr, align 4, !tbaa !299
  store ptr %count2_out, ptr %count2_out.addr, align 4, !tbaa !299
  ...
  %0 = load ptr, ptr %a.addr, align 4, !tbaa !299
  %1 = load i32, ptr %off.addr, align 4, !tbaa !310
  %2 = load i32, ptr %inc1.addr, align 4, !tbaa !310
  %3 = load i32, ptr %inc2.addr, align 4, !tbaa !310
  %4 = load ptr, ptr %count1_out.addr, align 4, !tbaa !299
  %5 = load ptr, ptr %count2_out.addr, align 4, !tbaa !299
  %6 = load %struct.ipd.custom_type.addr_t.addr_t, ptr %size1, align 4, !tbaa !398
  %7 = load %struct.ipd.custom_type.addr_t.addr_t, ptr %count1_in, align 4, !tbaa !398
  %8 = load %struct.ipd.custom_type.addr_t.addr_t, ptr %4, align 4, !tbaa !398
  %9 = load %struct.ipd.custom_type.addr_t.addr_t, ptr %size2, align 4, !tbaa !398
  %10 = load %struct.ipd.custom_type.addr_t.addr_t, ptr %count2_in, align 4, !tbaa !398
  %11 = load %struct.ipd.custom_type.addr_t.addr_t, ptr %5, align 4, !tbaa !398
  ...
  %18 = load ptr, ptr %count1_out.addr, align 4, !tbaa !299
  %19 = load %struct.ipd.custom_type.addr_t.addr_t, ptr %o1, align 1, !tbaa !398
  store %struct.ipd.custom_type.addr_t.addr_t %19, ptr %18, align 4, !tbaa !398
  ...
  %20 = load ptr, ptr %count2_out.addr, align 4, !tbaa !299
  %21 = load %struct.ipd.custom_type.addr_t.addr_t, ptr %o2, align 1, !tbaa !398
  store %struct.ipd.custom_type.addr_t.addr_t %21, ptr %20, align 4, !tbaa !398
  ...
  %22 = load ptr, ptr %o0, align 1, !tbaa !473
...
; Function Attrs: inlinehint mustprogress nounwind
define internal void @_ZL11window_incrP13output_windowIfEi(ptr %w, i32 noundef %count) addrspace(1) #4 !dbg !475 !noalias !481 {
entry:
  %w.addr = alloca ptr, align 4
  %count.addr = alloca i32, align 4
  store ptr %w, ptr %w.addr, align 4, !tbaa !299, !noalias !481
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %w.addr, metadata !479, metadata !DIExpression()), !dbg !484
  store i32 %count, ptr %count.addr, align 4, !tbaa !310, !noalias !481
  call addrspace(1) void @llvm.dbg.declare(metadata ptr %count.addr, metadata !480, metadata !DIExpression()), !dbg !484
  %0 = load i32, ptr %count.addr, align 4, !dbg !484, !tbaa !310, !noalias !481
  %mul = mul i32 %0, 4, !dbg !484
  store i32 %mul, ptr %count.addr, align 4, !dbg !484, !tbaa !310, !noalias !481
  %1 = load ptr, ptr %w.addr, align 4, !dbg !484, !tbaa !299, !noalias !481
  %ptr = getelementptr inbounds %struct.output_window, ptr %1, i32 0, i32 2, !dbg !484
  %2 = load ptr, ptr %ptr, align 4, !dbg !484, !tbaa !352, !noalias !481
  %3 = call addrspace(1) ptr @llvm.noalias.p0.p0.p0.i32(ptr %2, ptr null, ptr %ptr, i32 0, metadata !481), !dbg !484, !tbaa !352, !noalias !481
  %4 = load i32, ptr %count.addr, align 4, !dbg !484, !tbaa !310, !noalias !481
  %5 = load ptr, ptr %w.addr, align 4, !dbg !484, !tbaa !299, !noalias !481
  %buffer = getelementptr inbounds %struct.output_window, ptr %5, i32 0, i32 5, !dbg !484
  %6 = load ptr, ptr %buffer, align 4, !dbg !484, !tbaa !485, !noalias !481
  %7 = call addrspace(1) ptr @llvm.noalias.p0.p0.p0.i32(ptr %6, ptr null, ptr %buffer, i32 0, metadata !481), !dbg !484, !tbaa !485, !noalias !481
  %8 = load ptr, ptr %w.addr, align 4, !dbg !484, !tbaa !299, !noalias !481
  %size = getelementptr inbounds %struct.output_window, ptr %8, i32 0, i32 7, !dbg !484
  %9 = load i32, ptr %size, align 4, !dbg !484, !tbaa !486, !noalias !481
  %call = call addrspace(1) ptr @_Z10cyclic_addPaiS_j(ptr %3, i32 noundef %4, ptr %7, i32 noundef %9) #12, !dbg !484, !noalias !481
  %10 = load ptr, ptr %w.addr, align 4, !dbg !484, !tbaa !299, !noalias !481
  %ptr1 = getelementptr inbounds %struct.output_window, ptr %10, i32 0, i32 2, !dbg !484
  store ptr %call, ptr %ptr1, align 4, !dbg !484, !tbaa !352, !noalias !481
  ret void, !dbg !484
}
...
!1 = !DIFile(filename: "/home/synthara/VersalPrjs/LDRD/rtda_demo/aieml7/window_split_256_to_128x2.cpp", directory: "/home/synthara/VersalPrjs/LDRD/rtda_demo/aieml7/Work/aie/ir")
!2 = !{!3, !19}
...
!255 = !DIFile(filename: "../../../window_split_256_to_128x2.h", directory: "/home/synthara/VersalPrjs/LDRD/rtda_demo/aieml7/Work/aie/ir")
!256 = !{i32 0, i8 undef}
!257 = !{i32 2, i8 undef}
!258 = !{i32 3, i8 undef}
!259 = !{i32 4, i8 undef}
...
!275 = distinct !DISubprogram(name: "window_split_256_to_128x2", linkageName: "_Z25window_split_256_to_128x2P12input_windowIfEP13output_windowIfES4_", scope: !276, file: !276, line: 3, type: !277, scopeLine: 5, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !283)
!276 = !DIFile(filename: "window_split_256_to_128x2.cpp", directory: "/home/synthara/VersalPrjs/LDRD/rtda_demo/aieml7")
...
!287 = !DILocalVariable(name: "HALF", scope: !275, file: !276, line: 6, type: !288)
!288 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !5)
!289 = !DILocalVariable(name: "i", scope: !290, file: !276, line: 8, type: !5)
!290 = distinct !DILexicalBlock(scope: !275, file: !276, line: 8, column: 3)
!291 = !DILocalVariable(name: "i", scope: !292, file: !276, line: 12, type: !5)
!292 = distinct !DILexicalBlock(scope: !275, file: !276, line: 12, column: 3)
!293 = !{!294}
!294 = distinct !{!294, !295, !"_Z25window_split_256_to_128x2P12input_windowIfEP13output_windowIfES4_: in"}
!295 = distinct !{!295, !"_Z25window_split_256_to_128x2P12input_windowIfEP13output_windowIfES4_"}
!296 = !{!294, !297, !298}
!297 = distinct !{!297, !295, !"_Z25window_split_256_to_128x2P12input_windowIfEP13output_windowIfES4_: out0"}
!298 = distinct !{!298, !295, !"_Z25window_split_256_to_128x2P12input_windowIfEP13output_windowIfES4_: out1"}
!299 = !{!300, !300, i64 0, i64 4}
!300 = !{!301, i64 4, !"any pointer"}
!301 = !{!302, i64 1, !"omnipotent char"}
!302 = !{!"Simple C++ TBAA"}
!303 = !DILocation(line: 3, column: 64, scope: !275)
!304 = !{!297}
!305 = !DILocation(line: 4, column: 65, scope: !275)
!306 = !{!298}
!307 = !DILocation(line: 5, column: 65, scope: !275)
!308 = !DILocation(line: 6, column: 3, scope: !275)
!309 = !DILocation(line: 6, column: 17, scope: !275)
!310 = !{!311, !311, i64 0, i64 4}
!311 = !{!301, i64 4, !"int"}
!312 = !DILocation(line: 8, column: 8, scope: !290)
!313 = !DILocation(line: 8, column: 12, scope: !290)
!314 = !DILocation(line: 8, column: 19, scope: !315)
!315 = distinct !DILexicalBlock(scope: !290, file: !276, line: 8, column: 3)
!316 = !DILocation(line: 8, column: 21, scope: !315)
!317 = !DILocation(line: 8, column: 3, scope: !290)
!318 = !DILocation(line: 8, column: 3, scope: !315)
!319 = !DILocation(line: 9, column: 22, scope: !320)
!320 = distinct !DILexicalBlock(scope: !315, file: !276, line: 8, column: 34)
!321 = !DILocation(line: 9, column: 44, scope: !320)
!322 = !DILocation(line: 9, column: 28, scope: !320)
!323 = !DILocation(line: 9, column: 5, scope: !320)
!324 = !DILocation(line: 10, column: 3, scope: !320)
!325 = !DILocation(line: 8, column: 29, scope: !315)
!326 = distinct !{!326, !317, !327, !328}
!327 = !DILocation(line: 10, column: 3, scope: !290)
!328 = !{!"llvm.loop.mustprogress"}
!329 = !DILocation(line: 12, column: 8, scope: !292)
!330 = !DILocation(line: 12, column: 12, scope: !292)
!331 = !DILocation(line: 12, column: 19, scope: !332)
!332 = distinct !DILexicalBlock(scope: !292, file: !276, line: 12, column: 3)
!333 = !DILocation(line: 12, column: 21, scope: !332)
!334 = !DILocation(line: 12, column: 3, scope: !292)
!335 = !DILocation(line: 12, column: 3, scope: !332)
!336 = !DILocation(line: 13, column: 22, scope: !337)
!337 = distinct !DILexicalBlock(scope: !332, file: !276, line: 12, column: 34)
!338 = !DILocation(line: 13, column: 44, scope: !337)
!339 = !DILocation(line: 13, column: 28, scope: !337)
!340 = !DILocation(line: 13, column: 5, scope: !337)
!341 = !DILocation(line: 14, column: 3, scope: !337)
!342 = !DILocation(line: 12, column: 29, scope: !332)
!343 = distinct !{!343, !334, !344, !328}
!344 = !DILocation(line: 14, column: 3, scope: !292)
!345 = !DILocation(line: 15, column: 1, scope: !275)
!346 = !{!347}
!347 = distinct !{!347, !348, !"_ZL16window_writeincrIL15aie_dm_resource0EEvP13output_windowIfEf: unknown scope"}
!348 = distinct !{!348, !"_ZL16window_writeincrIL15aie_dm_resource0EEvP13output_windowIfEf"}
!349 = !DILocation(line: 903, column: 3, scope: !76)
!350 = !{!351, !351, i64 0, i64 4}
!351 = !{!301, i64 4, !"float"}
!352 = !{!353, !300, i64 8, i64 4}
!353 = !{!301, i64 52, !"_ZTS13output_windowIfE", !311, i64 0, i64 4, !311, i64 4, i64 4, !300, i64 8, i64 4, !300, i64 12, i64 4, !300, i64 16, i64 8, !300, i64 24, i64 4, !300, i64 28, i64 8, !311, i64 36, i64 4, !311, i64 40, i64 4, !311, i64 44, i64 8}
!354 = distinct !DISubprogram(name: "window_readincr<(aie_dm_resource)0>", linkageName: "_ZL15window_readincrIL15aie_dm_resource0EEfP12input_windowIfE", scope: !27, file: !27, line: 903, type: !355, scopeLine: 903, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, templateParams: !63, retainedNodes: !357)
!355 = !DISubroutineType(types: !356)
!356 = !{!58, !31}
!357 = !{!358, !359}
!358 = !DILocalVariable(name: "w", arg: 1, scope: !354, file: !27, line: 903, type: !31)
!359 = !DILocalVariable(name: "value", scope: !354, file: !27, line: 903, type: !58)
!360 = !DILocation(line: 903, column: 3, scope: !354)
!361 = !{!362}
!362 = distinct !{!362, !363, !"_ZL15window_readincrIL15aie_dm_resource0EEvP12input_windowIfERf: unknown scope"}
!363 = distinct !{!363, !"_ZL15window_readincrIL15aie_dm_resource0EEvP12input_windowIfERf"}
!364 = !DILocation(line: 903, column: 3, scope: !28)
!365 = !{!366, !300, i64 8, i64 4}
!366 = !{!301, i64 52, !"_ZTS12input_windowIfE", !311, i64 0, i64 4, !311, i64 4, i64 4, !300, i64 8, i64 4, !300, i64 12, i64 4, !300, i64 16, i64 8, !300, i64 24, i64 4, !300, i64 28, i64 8, !311, i64 36, i64 4, !311, i64 40, i64 4, !311, i64 44, i64 8}
!367 = distinct !DISubprogram(name: "window_incr", linkageName: "_ZL11window_incrP12input_windowIfEi", scope: !27, file: !27, line: 520, type: !368, scopeLine: 520, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !370)
!368 = !DISubroutineType(types: !369)
!369 = !{null, !31, !5}
!370 = !{!371, !372}
!371 = !DILocalVariable(name: "w", arg: 1, scope: !367, file: !27, line: 520, type: !31)
!372 = !DILocalVariable(name: "count", arg: 2, scope: !367, file: !27, line: 520, type: !5)
!373 = !{!374}
!374 = distinct !{!374, !375, !"_ZL11window_incrP12input_windowIfEi: unknown scope"}
!375 = distinct !{!375, !"_ZL11window_incrP12input_windowIfEi"}
!376 = !DILocation(line: 520, column: 3, scope: !367)
!377 = !{!366, !300, i64 24, i64 4}
!378 = !{!366, !311, i64 36, i64 4}
!379 = distinct !DISubprogram(name: "cyclic_add", linkageName: "_Z10cyclic_addPaiS_j", scope: !41, file: !41, line: 12, type: !380, scopeLine: 12, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !382)
!380 = !DISubroutineType(types: !381)
!381 = !{!39, !39, !5, !39, !21}
!382 = !{!383, !384, !385, !386, !387, !389}
!383 = !DILocalVariable(name: "ptr", arg: 1, scope: !379, file: !41, line: 12, type: !39)
!384 = !DILocalVariable(name: "count", arg: 2, scope: !379, file: !41, line: 12, type: !5)
!385 = !DILocalVariable(name: "base", arg: 3, scope: !379, file: !41, line: 12, type: !39)
!386 = !DILocalVariable(name: "size", arg: 4, scope: !379, file: !41, line: 12, type: !21)
!387 = !DILocalVariable(name: "c0", scope: !379, file: !41, line: 13, type: !388)
!388 = !DIDerivedType(tag: DW_TAG_typedef, name: "addr_t", file: !20, line: 474, baseType: !96)
!389 = !DILocalVariable(name: "c1", scope: !379, file: !41, line: 14, type: !388)
!390 = !DILocation(line: 12, column: 54, scope: !379)
!391 = !DILocation(line: 12, column: 63, scope: !379)
!392 = !DILocation(line: 12, column: 87, scope: !379)
!393 = !DILocation(line: 12, column: 106, scope: !379)
!394 = !DILocation(line: 13, column: 5, scope: !379)
!395 = !DILocation(line: 13, column: 12, scope: !379)
!396 = !DILocation(line: 13, column: 23, scope: !379)
!397 = !DILocation(line: 13, column: 17, scope: !379)
!398 = !{!399, !399, i64 0, i64 4}
!399 = !{!301, i64 4, !"addr_t"}
!400 = !DILocation(line: 14, column: 5, scope: !379)
!401 = !DILocation(line: 14, column: 12, scope: !379)
!402 = !DILocation(line: 14, column: 23, scope: !379)
!403 = !DILocation(line: 14, column: 17, scope: !379)
!404 = !DILocation(line: 15, column: 24, scope: !379)
!405 = !DILocation(line: 15, column: 29, scope: !379)
!406 = !DILocation(line: 15, column: 35, scope: !379)
!407 = !DILocation(line: 15, column: 34, scope: !379)
!408 = !DILocation(line: 15, column: 48, scope: !379)
!409 = !DILocation(line: 15, column: 53, scope: !379)
!410 = !DILocation(line: 15, column: 52, scope: !379)
!411 = !DILocation(line: 15, column: 41, scope: !379)
!412 = !DILocation(line: 15, column: 65, scope: !379)
!413 = !DILocation(line: 15, column: 71, scope: !379)
!414 = !DILocation(line: 15, column: 70, scope: !379)
!415 = !DILocation(line: 15, column: 84, scope: !379)
!416 = !DILocation(line: 15, column: 89, scope: !379)
!417 = !DILocation(line: 15, column: 88, scope: !379)
!418 = !DILocation(line: 15, column: 95, scope: !379)
!419 = !DILocation(line: 15, column: 94, scope: !379)
!420 = !DILocation(line: 15, column: 77, scope: !379)
!421 = !DILocation(line: 15, column: 106, scope: !379)
!422 = !DILocation(line: 15, column: 12, scope: !379)
!423 = !DILocation(line: 16, column: 1, scope: !379)
!424 = !DILocation(line: 15, column: 5, scope: !379)
!425 = distinct !DISubprogram(name: "add_3d_byte<signed char>", linkageName: "_Z11add_3d_byteIaEPT_S1_iiR6addr_tiiS3_i", scope: !66, file: !66, line: 123, type: !426, scopeLine: 123, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, templateParams: !441, retainedNodes: !429)
!426 = !DISubroutineType(types: !427)
!427 = !{!72, !72, !5, !5, !428, !5, !5, !428, !5}
!428 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !388, size: 32)
!429 = !{!430, !431, !432, !433, !434, !435, !436, !437, !438, !439, !440}
!430 = !DILocalVariable(name: "a", arg: 1, scope: !425, file: !66, line: 123, type: !72)
!431 = !DILocalVariable(name: "off", arg: 2, scope: !425, file: !66, line: 123, type: !5)
!432 = !DILocalVariable(name: "size1", arg: 3, scope: !425, file: !66, line: 123, type: !5)
!433 = !DILocalVariable(name: "count1", arg: 4, scope: !425, file: !66, line: 123, type: !428)
!434 = !DILocalVariable(name: "inc1", arg: 5, scope: !425, file: !66, line: 123, type: !5)
!435 = !DILocalVariable(name: "size2", arg: 6, scope: !425, file: !66, line: 123, type: !5)
!436 = !DILocalVariable(name: "count2", arg: 7, scope: !425, file: !66, line: 123, type: !428)
!437 = !DILocalVariable(name: "inc2", arg: 8, scope: !425, file: !66, line: 123, type: !5)
!438 = !DILocalVariable(name: "c", scope: !425, file: !66, line: 124, type: !388)
!439 = !DILocalVariable(name: "c2", scope: !425, file: !66, line: 125, type: !388)
!440 = !DILocalVariable(name: "r", scope: !425, file: !66, line: 126, type: !72)
!441 = !{!442}
!442 = !DITemplateTypeParameter(name: "T", type: !44)
!443 = !DILocation(line: 123, column: 26, scope: !425)
!444 = !DILocation(line: 123, column: 33, scope: !425)
!445 = !DILocation(line: 123, column: 42, scope: !425)
!446 = !DILocation(line: 123, column: 57, scope: !425)
!447 = !DILocation(line: 123, column: 69, scope: !425)
!448 = !DILocation(line: 123, column: 79, scope: !425)
!449 = !DILocation(line: 123, column: 94, scope: !425)
!450 = !DILocation(line: 123, column: 106, scope: !425)
!451 = !DILocation(line: 124, column: 5, scope: !425)
!452 = !DILocation(line: 124, column: 12, scope: !425)
!453 = !DILocation(line: 125, column: 5, scope: !425)
!454 = !DILocation(line: 125, column: 12, scope: !425)
!455 = !DILocation(line: 126, column: 5, scope: !425)
!456 = !DILocation(line: 126, column: 8, scope: !425)
!457 = !DILocation(line: 126, column: 32, scope: !425)
!458 = !DILocation(line: 126, column: 35, scope: !425)
!459 = !DILocation(line: 126, column: 40, scope: !425)
!460 = !DILocation(line: 126, column: 46, scope: !425)
!461 = !DILocation(line: 126, column: 52, scope: !425)
!462 = !DILocation(line: 126, column: 59, scope: !425)
!463 = !DILocation(line: 126, column: 70, scope: !425)
!464 = !DILocation(line: 126, column: 77, scope: !425)
!465 = !DILocation(line: 126, column: 16, scope: !425)
!466 = !DILocation(line: 127, column: 5, scope: !425)
!467 = !DILocation(line: 127, column: 12, scope: !425)
!468 = !DILocation(line: 128, column: 5, scope: !425)
!469 = !DILocation(line: 128, column: 12, scope: !425)
!470 = !DILocation(line: 129, column: 12, scope: !425)
!471 = !DILocation(line: 130, column: 1, scope: !425)
!472 = !DILocation(line: 129, column: 5, scope: !425)
!473 = !{!474, !300, i64 0, i64 4}
!474 = !{!301, i64 12, !"_ZTS103chessout___Pvoid_add_3d_byte_int___Pvoid___sint___sint___sint_addr_t_addr_t_addr_t_addr_t_addr_t_addr_t", !300, i64 0, i64 4, !399, i64 4, i64 4, !399, i64 8, i64 4}
!475 = distinct !DISubprogram(name: "window_incr", linkageName: "_ZL11window_incrP13output_windowIfEi", scope: !27, file: !27, line: 530, type: !476, scopeLine: 530, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !478)
!476 = !DISubroutineType(types: !477)
!477 = !{null, !79, !5}
!478 = !{!479, !480}
!479 = !DILocalVariable(name: "w", arg: 1, scope: !475, file: !27, line: 530, type: !79)
!480 = !DILocalVariable(name: "count", arg: 2, scope: !475, file: !27, line: 530, type: !5)
!481 = !{!482}
!482 = distinct !{!482, !483, !"_ZL11window_incrP13output_windowIfEi: unknown scope"}
!483 = distinct !{!483, !"_ZL11window_incrP13output_windowIfEi"}
!484 = !DILocation(line: 530, column: 3, scope: !475)
!485 = !{!353, !300, i64 24, i64 4}
!486 = !{!353, !311, i64 36, i64 4}
