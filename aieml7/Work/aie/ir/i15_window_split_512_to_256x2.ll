; ModuleID = 'i15_window_split_512_to_256x2.ll'
source_filename = "/home/synthara/VersalPrjs/LDRD/rtda_demo/aieml7/window_split_512_to_256x2.cpp"
...
define dso_local void @_Z25window_split_512_to_256x2P12input_windowIfEP13output_windowIfES4_(ptr chesscopy noalias %in, ptr chesscopy noalias %out0, ptr chesscopy noalias %out1) addrspace(1) #0 !dbg !275 {
entry:
  ...
  store i32 256, ptr %HALF, align 4, !dbg !309, !tbaa !310, !noalias !296
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %cmp = icmp slt i32 %3, 256, !dbg !316
...
for.cond2:                                        ; preds = %for.inc7, %for.end
  ...
  %cmp3 = icmp slt i32 %9, 256, !dbg !333
...
!1 = !DIFile(filename: "/home/synthara/VersalPrjs/LDRD/rtda_demo/aieml7/window_split_512_to_256x2.cpp", directory: "/home/synthara/VersalPrjs/LDRD/rtda_demo/aieml7/Work/aie/ir")
!2 = !{!3, !19}
...
!255 = !DIFile(filename: "../../../window_split_512_to_256x2.h", directory: "/home/synthara/VersalPrjs/LDRD/rtda_demo/aieml7/Work/aie/ir")
!256 = !{i32 0, i8 undef}
!257 = !{i32 2, i8 undef}
!258 = !{i32 3, i8 undef}
!259 = !{i32 4, i8 undef}
...
!275 = distinct !DISubprogram(name: "window_split_512_to_256x2", linkageName: "_Z25window_split_512_to_256x2P12input_windowIfEP13output_windowIfES4_", scope: !276, file: !276, line: 3, type: !277, scopeLine: 5, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !283)
!276 = !DIFile(filename: "window_split_512_to_256x2.cpp", directory: "/home/synthara/VersalPrjs/LDRD/rtda_demo/aieml7")
...
!293 = !{!294}
!294 = distinct !{!294, !295, !"_Z25window_split_512_to_256x2P12input_windowIfEP13output_windowIfES4_: in"}
!295 = distinct !{!295, !"_Z25window_split_512_to_256x2P12input_windowIfEP13output_windowIfES4_"}
!296 = !{!294, !297, !298}
!297 = distinct !{!297, !295, !"_Z25window_split_512_to_256x2P12input_windowIfEP13output_windowIfES4_: out0"}
!298 = distinct !{!298, !295, !"_Z25window_split_512_to_256x2P12input_windowIfEP13output_windowIfES4_: out1"}
