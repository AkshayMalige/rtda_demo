...
namespace s2_fw {
#include "../../../hls_projects/split_solver2/firmware/defines.h"
#include "../../../hls_projects/split_solver2/firmware/parameters.h"
}

void solver2_run(hls::stream<hidden_t>& curr, hls::stream<hidden_t>& prev, hls::stream<hidden_t>& out) {
