...
public:
    ...
    NeuralNetworkGraph() {
        ...
        connect<>(embed_input_gmio.out[0], solver0_rollconcat.in[0]);
        dimensions(solver0_rollconcat.in[0])  = {HIDDEN_SIZE};
        dimensions(solver0_rollconcat.out[0]) = {2 * HIDDEN_SIZE};
        // dimensions(solver0_rollconcat.in[0])  = {10};
        // dimensions(solver0_rollconcat.out[0]) = {2 * 10};
 ...
 // // // Output  -------------------------------------------------
        ...
        // connect<parameter>(output_matrixA_rtp, async(output_dense0.matrixA[0]));
        ...
        connect<>(solver0_rollconcat.out[0], embed_output_gmio.in[0]);
