...
// SUBSOLVER1 graph sizes ---------------------------------------------------
constexpr int SUBSOLVER1_INPUT_SIZE = 768;
constexpr int SUBSOLVER1_INPUT_PARTS = 12;
constexpr int SUBSOLVER1_INPUT_PART_SIZE = SUBSOLVER1_INPUT_SIZE / SUBSOLVER1_INPUT_PARTS;
constexpr int SUBSOLVER1_DENSE0_INPUT_SIZE = SUBSOLVER1_INPUT_SIZE;
constexpr int SUBSOLVER1_DENSE0_WEIGHTS_SIZE = HIDDEN_SIZE * SUBSOLVER1_DENSE0_INPUT_SIZE;
constexpr int SUBSOLVER1_DENSE0_WEIGHTS_PART_SIZE = HIDDEN_SIZE * SUBSOLVER1_INPUT_PART_SIZE;
constexpr int SUBSOLVER1_DENSE0_BIAS_SIZE = HIDDEN_SIZE;
constexpr int SUBSOLVER1_LAYER_WEIGHTS_PARTS = 2;
constexpr int SUBSOLVER1_LAYER_WEIGHTS_PART_SIZE = OUTPUT_SIZE * (HIDDEN_SIZE / SUBSOLVER1_LAYER_WEIGHTS_PARTS);
constexpr int SUBSOLVER1_LAYER_BIAS_SIZE = OUTPUT_SIZE;
constexpr int SUBSOLVER1_DENSE1_WEIGHTS_SIZE = HIDDEN_SIZE * HIDDEN_SIZE;
constexpr int SUBSOLVER1_DENSE1_WEIGHTS_PART_SIZE = SUBSOLVER1_LAYER_WEIGHTS_PART_SIZE;
constexpr int SUBSOLVER1_DENSE1_BIAS_SIZE = SUBSOLVER1_LAYER_BIAS_SIZE;
constexpr int SUBSOLVER1_DENSE2_WEIGHTS_SIZE = HIDDEN_SIZE * HIDDEN_SIZE;
constexpr int SUBSOLVER1_DENSE2_WEIGHTS_PART_SIZE = SUBSOLVER1_LAYER_WEIGHTS_PART_SIZE;
constexpr int SUBSOLVER1_DENSE2_BIAS_SIZE = SUBSOLVER1_LAYER_BIAS_SIZE;
constexpr int SUBSOLVER1_DENSE3_WEIGHTS_SIZE = HIDDEN_SIZE * HIDDEN_SIZE;
constexpr int SUBSOLVER1_DENSE3_WEIGHTS_PART_SIZE = SUBSOLVER1_LAYER_WEIGHTS_PART_SIZE;
constexpr int SUBSOLVER1_DENSE3_BIAS_SIZE = SUBSOLVER1_LAYER_BIAS_SIZE;
constexpr int SUBSOLVER1_FINAL_OUTPUT_SIZE = OUTPUT_SIZE;
