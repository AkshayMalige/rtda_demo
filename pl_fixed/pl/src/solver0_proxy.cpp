...
namespace s0_fw {
#include "../../../hls_projects/split_solver0/firmware/defines.h"
#include "../../../hls_projects/split_solver0/firmware/parameters.h"
}
...
void solver0_run(hls::stream<hidden_t>& curr, hls::stream<hidden_t>& prev, hls::stream<hidden_t>& out) {
    ...
    if (!loaded) {
        nnet::load_weights_from_txt<model_default_t, 16384>(w3,  "s0_w3.txt");
        nnet::load_weights_from_txt<model_default_t, 128>(b3,    "s0_b3.txt");
        nnet::load_weights_from_txt<model_default_t, 16384>(w5,  "s0_w5.txt");
        nnet::load_weights_from_txt<bias5_t, 128>(b5,            "s0_b5.txt");
        nnet::load_weights_from_txt<model_default_t, 16384>(w9,  "s0_w9.txt");
        nnet::load_weights_from_txt<model_default_t, 128>(b9,    "s0_b9.txt");
        nnet::load_weights_from_txt<model_default_t, 16384>(w12, "s0_w12.txt");
        nnet::load_weights_from_txt<model_default_t, 128>(b12,   "s0_b12.txt");
        nnet::load_weights_from_txt<model_default_t, 16384>(w15, "s0_w15.txt");
        nnet::load_weights_from_txt<model_default_t, 128>(b15,   "s0_b15.txt");
        loaded = true;
    }
#endif
