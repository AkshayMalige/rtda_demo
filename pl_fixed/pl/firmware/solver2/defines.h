...
typedef rtda_table_t s2_d0_act_table_t;
typedef rtda_accum_t s2_d1_accum_t;
typedef nnet::array<rtda_act_t, 128*1> layer9_t;
typedef ap_uint<1> layer9_index;
typedef nnet::array<rtda_act_t, 128*1> layer11_t;
typedef rtda_table_t s2_d1_act_table_t;
typedef rtda_accum_t s2_d2_accum_t;
