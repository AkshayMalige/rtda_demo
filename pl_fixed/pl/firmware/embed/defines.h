...
typedef nnet::array<rtda_act_t, 6*1> input_t;
typedef rtda_accum_t emb_d0_accum_t;
typedef nnet::array<rtda_act_t, 128*1> layer2_t;
typedef rtda_weight_t model_default_t;
typedef ap_uint<1> layer2_index;
typedef nnet::array<rtda_act_t, 128*1> layer4_t;
typedef rtda_table_t emb_d0_act_table_t;
typedef rtda_accum_t emb_d1_accum_t;
typedef nnet::array<rtda_act_t, 128*1> layer5_t;
typedef ap_uint<1> layer5_index;
typedef nnet::array<rtda_act_t, 128*1> result_t;
typedef rtda_table_t emb_d1_act_table_t;
