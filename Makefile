...
############################################################################
#  Usage:
#     make TARGET=<sw_emu|hw_emu|hw>  EMU_PS=<X86|QEMU>
############################################################################
...
# Pass the same flags to every sub-Makefile
...
##############################  Package  ###################################
package: aie pl host hw_link
	$(MAKE) XCLBIN=$(XCLBIN) do_package $(SUBOPTS)
