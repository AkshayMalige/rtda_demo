...
using TT_DATA   = float16;
using TT_WEIGHT = float16;
...
static constexpr unsigned int TP_CASC_LEN         = (INPUT_SIZE + MAX_INPUTS_PER_TILE - 1) / MAX_INPUTS_PER_TILE;
static_assert(INPUT_SIZE % TP_CASC_LEN == 0, "Input size must divide cascade length");
