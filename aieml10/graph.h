...
public:
    ...
    NeuralNetworkGraph() {
        ...
        // connect<window<WINDOW_BYTES_HIDDEN>>(solver2_relu0.out[0], pipeline_out.in[0]);
        ...
        connect<window<WINDOW_BYTES_HIDDEN>>(solver2_bias1.out[0], pipeline_out.in[0]);
